...
"CON-teksht."  Basically, pretend you're Sean Connery saying the word "Context."  There's an "H" in it, you see, for Haskell, and I thought that was more fun than calling it "HContext".  (Though now you have to watch out if you're using an editor with naive autocompletion:  "Contexht" is the name of the library, "Context" is one of the constructors.)
